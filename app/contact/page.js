...
export default function page() {
  return (
    <div className='w-full h-screen px-10'>
      <div className='container h-full flex flex-col justify-center items-center mx-auto gap-y-4 py-32'>
        ...
        <div className=' w-full max-w-[700px]'>
          <form className='flex flex-col gap-y-5 mx-auto' action="/send-data-here" method="post">
            ...
            <textarea className='textarea bg-secondary/5 shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline focus:border-semantic border-secondary' id="message" name="message" placeholder='Message'></textarea>
