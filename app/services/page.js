...
import ServiceSlider from '../about/ServiceSlider'

export default function page() {
  return (
    <div className='w-full h-full'>
      <div className='h-full container mx-auto flex flex-col xl:flex-row justify-center items-center gap-y-10 xl:gap-x-10 px-6 xl:px-16'>
        <div className='heading&paragraph text-center xl:text-left xl:min-h-[300px]'>
          <div className='text-5xl mb-4'>My Servcies <span className='text-semantic'>.</span></div>
